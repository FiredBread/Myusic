    ...
    public partial class Form1 : Form
    {
        ...
        public void getMusicList()
        {
            ...
            if (File.Exists("music.list") == true)
            {
                ...
                musicNum.Text = (musicName.Length).ToString() + "/";
                musicnumber = 0;
            }
            else { }
        }//获取歌列表
        ...
        {
            buttomName.SetBounds(3, 0, buttomName.Width, buttomName.Height);
            name.SetBounds(3, 0, name.Width, name.Height);
           musicnumber++;
